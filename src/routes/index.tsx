          ...
          <div class="fb-stage">
            <div class="fb-cover__card">
              ...
              <p class="fb-cover__sub">
                {isTech.value
                  ? "Tough workwear, built for the crew."
                  : "Official Farm Boy gear, worn with pride."}
              </p>
...
export const head: DocumentHead = {
  ...
  meta: [
    ...
    { property: "og:image", content: "https://farmboyapparel.ca/farmboy-logo.png" },
    ...
    { name: "twitter:image", content: "https://farmboyapparel.ca/farmboy-logo.png" },
  ],
};
